...
/**
 * This is the model class for table "nilai2_karyawan2".
 *
 * The followings are the available columns in table 'nilai2_karyawan2':
 * @property integer $id
 ...
 */
class Nilai2Karyawan2 extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Nilai2Karyawan2 the static model class
	 */
