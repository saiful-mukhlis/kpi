 ...
 * @property BobotNilaiTotal[] $bobotNilaiTotals
...
class Periode extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'bobotNilaiTotals' => array(self::HAS_MANY, 'BobotNilaiTotal', 'periodeid'),
			'nilais' => array(self::HAS_MANY, 'Nilai', 'periodeid'),
			'nilai2Karyawans' => array(self::HAS_MANY, 'Nilai2Karyawan', 'periodeid'),
			'nilaiTotalKaryawans' => array(self::HAS_MANY, 'NilaiTotalKaryawan', 'periodeid'),
		);
	}
