...
<div class="accordion-group">
  ...
  <div id="collapse<?php echo $model->id;?>" class="accordion-body collapse">
    <div class="accordion-inner">
		...
		<?php echo $this->renderPartial('_view_core',array('periode'=>$periode, 'devisiid'=>$devisiid, 'upid'=>$karyawanid,'karyawanid'=>$model->id, 'level'=>2, 'n2s'=>$n2s));?>
    </div>
  </div>
</div>
<?php 
